...
vi.mock('../src/pages/EarningsPage', () => ({ default: () => <div>EarningsPage</div> }))
vi.mock('../src/pages/OrgPage', () => ({ default: () => <div>OrgPage</div> }))
vi.mock('../src/pages/OrgSettingsPage', () => ({ default: () => <div>OrgSettingsPage</div> }))
vi.mock('../src/pages/CoursesPage', () => ({ default: () => <div>CoursesPage</div> }))
vi.mock('../src/pages/CoursePage', () => ({ default: () => <div>CoursePage</div> }))
vi.mock('../src/pages/CourseBuilderPage', () => ({ default: () => <div>CourseBuilderPage</div> }))
vi.mock('../src/pages/CommunityPage', () => ({ default: () => <div>CommunityPage</div> }))
vi.mock('../src/pages/SpacePage', () => ({ default: () => <div>SpacePage</div> }))
vi.mock('../src/pages/MarketplacePage', () => ({ default: () => <div>MarketplacePage</div> }))
vi.mock('../src/pages/MarketplaceItemPage', () => ({ default: () => <div>MarketplaceItemPage</div> }))
...
vi.mock('../src/pages/ReadingListsPage', () => ({ default: () => <div>ReadingListsPage</div> }))
vi.mock('../src/pages/NewsletterPage', () => ({ default: () => <div>NewsletterPage</div> }))
